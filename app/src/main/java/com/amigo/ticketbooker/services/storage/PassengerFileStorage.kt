...
import com.amigo.ticketbooker.services.BerthPreference
import com.amigo.ticketbooker.services.Gender
import com.amigo.ticketbooker.services.Passenger
...
class PassengerFileStorage(private val context: Context) {
    ...
    private fun getStorageDirectory(): File {
        ...
        val publicDir = if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.R) {
